...
submit5.addEventListener('click', function(){
    ...
    //Funcional + Um
    if(respostas.get('question1') == 3 && respostas.get('question2') == 2){
        nomes = nomes + "2DES"
    }

    //Funcional/Completo + um 
    if((respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2){
        nomes = nomes + "3E | Aesthetic Scale | Attrak-Work questionnaire | AttrakDiff | Audio Narrative | Context-aware ESM | Controlled observation | Day Reconstruction Method | Differential Emotions Scale | EMO2 | Emoscope " +
    "| Emotion Cards | Emotion Sampling Device | Experience Sampling Method | Extended usability testing | Facereader  | Fun Toolkit | Game experience questionnaire | Geneva Appraisal Questionnaire | Geneva Emotion Wheel | Hedonic Utility scale | Human Computer trus | Intrinsic motivation inventory | Long term diary study | Mental effort | PAD | Positive and Negative Affect Scale | Presence questionnaire | Reaction checklists | Self Assessment Scal | Sensual Evaluation Instrument | ServUX questionnaire | SUMI | This-or-that | Timed ESM | TRUE Tracking Realtime User Experience | TUMCAT |  UTAUT | UX laddering |"
} 

    //conceitual/Funcional/Completo + Par)
    if((respostas.get('question1') == 1 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 4){
        nomes = nomes + "Co-discovery |" 
    } 

    //conceitual/Funcional/Completo + um/Par
    if((respostas.get('question1') == 1 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 04 || respostas.get('question2') == 2){
        nomes = nomes + "Private camera conversation |" 
    } 

    //Connceitual/Completo + Um
    if((respostas.get('question1') == 1 || respostas.get('question1') == 4) && respostas.get('question2') == 2){
        nomes = nomes + "Contextual Laddering | Perceived Comfort Assessment" 
    } 

    //funcional/Completo + par
    if((respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 4){
        nomes = nomes + "Experience Clip |" 
    } 

    //Inicial/Funcional/Completo + Um
    if((respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2){
        nomes = nomes + "Emocards | I.D. Tool | Mental mapping | Mindmap " 
    } 

    //Conceitual/Inicial/Funcional/Completo + Um/par
    if((respostas.get('question1') == 1 || respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2 || respostas.get('question2') == 4 ){
        nomes = nomes + "Emofaces | Exploration test | Semi-structured experience interview" 
    } 
    ///Inicial/Funcional/Completo + expert
    if((respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 1){
        nomes = nomes + "| Perspective-Based Inspection |" 
    } 

    // Inicial/Funcional/Completo + Um/grupos
    if((respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2 || respostas.get('question2') == 3){
        nomes = nomes + "| Product Personality Assignment |" 
    } 

     //Conceitual/Inicial + Expert/Um/Grupos
     if((respostas.get('question1') == 1 || respostas.get('question1') == 2) && respostas.get('question2') == 1 || respostas.get('question2') == 2 || respostas.get('question2') == 3){
        nomes = nomes + "Contextual Laddering | Perceived Comfort Assessment" 
    } 

    //Conceitual/Inicial + Um/
    if((respostas.get('question1') == 1 || respostas.get('question1') == 2) && respostas.get('question2') == 2){
        nomes = nomes + "| Workshops + probe interviews |" 
    } 

    //Conceitual/Inicial/Funcional/Completo + Um
    if((respostas.get('question1') == 1 || respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2){
        nomes = nomes + "Physiological arousal via electrodermal activity " 
    }
    
    //Conceitual/Inicial/Funcional/Completo + Um/expert
    if((respostas.get('question1') == 1 || respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) && respostas.get('question2') == 2 || respostas.get('question2') == 1 ){
        nomes = nomes + "| Paired comparison | Repertory Grid Technique" 
    } 
    //Conceitual/Inicial/Funcional/Completo + expert
    if((respostas.get('question1') == 1 || respostas.get('question1') == 2 || respostas.get('question1') == 3 || respostas.get('question1') == 4) &&  respostas.get('question2') == 1 ){
        nomes = nomes + "| Playability heuristics | UX Expert evaluation" 
     } 

      //Conceitual/Funcional/Completo + Um
    if((respostas.get('question1') == 1 || respostas.get('question1') == 3 || respostas.get('question1') == 4) &&  respostas.get('question2') == 2 ){
        nomes = nomes + "| PrEmo | Psychophysiological measurements | Sentence Completion" 
     } 

    //Conceitual/Completo + Expert/Um
    if((respostas.get('question1') == 1 || respostas.get('question1') == 4) && respostas.get('question2') == 2 || respostas.get('question2') == 1){
        nomes = nomes + "Experiential Contextual Inquiry |" 
    } 

    //Conceitual/Completo + Um/Grupo
    if((respostas.get('question1') == 1 || respostas.get('question1') == 4) && respostas.get('question2') == 2 || respostas.get('question2') == 2  ||  respostas.get('question2') == 3){
        nomes = nomes + "Kansei Engineering Software |" 
    } 

    //Conceitual/Completo + Um
    if((respostas.get('question1') == 1 || respostas.get('question1') == 4) || respostas.get('question2') == 2){
        nomes = nomes + "Multiple Sorting Method  |" 
    } 

     //Inicial/Funcional + Expert
     if((respostas.get('question1') == 2 || respostas.get('question1') == 3) && respostas.get('question2') == 1){
        nomes = nomes + "Immersion | Property checklists" 
    } 

    //Completo + Um
    if((respostas.get('question1') == 4) && respostas.get('question2') == 2){
        nomes = nomes + " Facial EMG | iScale | Product Attachment Scale | Product Experience Tracker |  UTAUT | UX Curve" 
    } 

    //Funcional + Um
    if((respostas.get('question1') == 3) && respostas.get('question2') == 2){
        nomes = nomes + " Feeltrace |" 
    }
    
    //inicial/Completo + grupo
    if((respostas.get('question1') == 2 || respostas.get('question1') == 4) && respostas.get('question2') == 3){
        nomes = nomes + "Group-based expert walkthrough |" 
    }


    //Completo + grupo
    if((respostas.get('question1') == 4) && respostas.get('question2') == 3){
        nomes = nomes + "Living Lab Method  |" 
    }

    //Conceitual + um
    if((respostas.get('question1') == 1) && respostas.get('question2') == 2){
        nomes = nomes + "QSA GQM questionnaires  |" 
    }



    //funcional + grupo
    if((respostas.get('question1') == 3) && respostas.get('question2') == 3){
        nomes = nomes + " OPOS – Outdoor Play Observation Scheme |" 
    }
